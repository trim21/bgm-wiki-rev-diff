...
// @require      https://cdn.jsdelivr.net/npm/diff2html@3.4.18/bundles/js/diff2html.min.js
// @require      https://cdn.jsdelivr.net/npm/diff@5.1.0/dist/diff.min.js
// @require      https://cdn.jsdelivr.net/npm/lodash@4.17.21/lodash.min.js
// @resource     diff2html https://cdn.jsdelivr.net/npm/diff2html@3.4.18/bundles/css/diff2html.min.css
...
async function initUI() {
  ...
  external_$_namespaceObject("#headerSubject").after(
  ...
  external_$_namespaceObject("head").append(style).append(
  ...
  external_$_namespaceObject('input[type="radio"]').on("change", function(e) {
    ...
    if (rev) {
      external_$_namespaceObject(`input[name="${selectName}"][value="${rev}"]`).css(
        "visibility",
        "hidden"
      );
      external_$_namespaceObject(`input[name="${selectName}"][value!="${rev}"]`).css(
  ...
  external_$_namespaceObject("#columnInSubjectA span.text").append(
